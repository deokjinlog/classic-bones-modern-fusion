...
pages = {
    "index.html": wrap("match-explorer.html", "매칭 탐색기 · classic-bones-modern-fusion",
        ...
        [("소재 발굴 →", "discover.html"), ("방법론 →", "method.html"), ("웹툰 「센터」 →", "center.html"), ("웹툰 「화물」 →", "cargo.html"), ("웹툰 「장부」 →", "coin.html"), ("GitHub →", GH)]),
    "discover.html": wrap("discover.html", "소재 발굴 · classic-bones-modern-fusion",
        "검증된 고전 뼈대 × 안 써본 현대 세팅 — 말 되는 조합 전체를 신선순으로 세운 소재 발굴 엔진.",
        [("매칭 탐색기 →", "./"), ("방법론 →", "method.html"), ("웹툰 「센터」 →", "center.html"), ("웹툰 「화물」 →", "cargo.html"), ("웹툰 「장부」 →", "coin.html"), ("GitHub →", GH)]),
    "center.html": wrap("center-webtoon.html", "센터 · classic-bones-modern-fusion",
        "고전 햄릿의 뼈대를 아이돌 기획사에 이식해 조준·생성한 웹툰 에피소드.",
        [("매칭 탐색기 →", "./"), ("소재 발굴 →", "discover.html"), ("웹툰 「화물」 →", "cargo.html"), ("웹툰 「장부」 →", "coin.html"), ("방법론 →", "method.html"), ("GitHub →", GH)]),
    "cargo.html": wrap("cargo-webtoon.html", "화물 · classic-bones-modern-fusion",
        "고전 오디세이의 뼈대를 우주 운송선에 이식해 조준·생성한 웹툰 에피소드.",
        [("매칭 탐색기 →", "./"), ("소재 발굴 →", "discover.html"), ("웹툰 「센터」 →", "center.html"), ("웹툰 「장부」 →", "coin.html"), ("방법론 →", "method.html"), ("GitHub →", GH)]),
    "coin.html": wrap("coin-webtoon.html", "장부 · classic-bones-modern-fusion",
        "고전 조사 미스터리(오이디푸스형)의 뼈대를 코인판에 이식해 조준·생성한 웹툰 에피소드.",
        [("매칭 탐색기 →", "./"), ("소재 발굴 →", "discover.html"), ("웹툰 「센터」 →", "center.html"), ("웹툰 「화물」 →", "cargo.html"), ("방법론 →", "method.html"), ("GitHub →", GH)]),
    "method.html": wrap("method.html", "만드는 법 · classic-bones-modern-fusion",
        "결정적 매칭·근거·6레버 깊이 — 이 도구가 어떻게 작동하는지의 메이킹 문서.",
        [("매칭 탐색기 →", "./"), ("소재 발굴 →", "discover.html"), ("웹툰 「센터」 →", "center.html"), ("웹툰 「화물」 →", "cargo.html"), ("웹툰 「장부」 →", "coin.html"), ("GitHub →", GH)]),
}
